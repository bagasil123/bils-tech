...
<body class="min-h-screen bg-paper-100 text-ink" x-data="{ sidebarOpen: false }">
    ...
    >
        ...
        <div class="border-t border-warm-border p-3 flex-shrink-0">
            <div class="flex items-center gap-3 mb-2 px-2">
                <div class="w-7 h-7 rounded-full bg-sienna/20 flex items-center justify-center text-sienna text-xs font-mono font-bold">
    ...
    <div class="lg:pl-60 min-h-screen flex flex-col">
        ...
        <div class="sticky top-0 z-10 h-14 bg-paper border-b border-warm-border flex items-center px-4 sm:px-6 gap-4">
            ...
            <h1 class="font-serif text-lg font-semibold text-ink">{{ $title ?? 'Dashboard' }}</h1>
        </div>
        ...
        <main class="flex-1 p-4 sm:p-6">
            {{-- Flash messages --}}
            @if(session('success'))
                <div class="mb-5 flex items-start gap-3 bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-sm text-sm" role="alert">
            ...
            @endif
            @if(session('error'))
                <div class="mb-5 flex items-start gap-3 bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-sm text-sm" role="alert">
